  ...
  return (
    <div className="flex flex-col py-8 md:py-12">
      <section className="w-full text-center py-16 md:py-24">
        <div className="mx-auto max-w-3xl border-2 border-foreground bg-paper p-8 paper-shadow">
      ...
      <section className="py-12">
        <div className="text-center mb-12">
          <h2 className="font-headline text-4xl md:text-5xl">Newest Creations</h2>
      ...
      <section className="py-12 mt-8">
        <div className="text-center mb-12 px-4">
          <h2 className="font-headline text-4xl md:text-5xl">Tried It!</h2>
