...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-auto items-center justify-center border bg-muted p-1 text-muted-foreground shadow-paper-sm",
      className
    )}
    {...props}
  />
